...
echo "You can access the mysql database management tool (phpmyadmin) at: http://$myIp/phpmyadmin "
echo "You can access the postgresql database management tool (phpmyadmin) at: http://$myIp/phppgadmin "
echo " "
echo " "
echo " "
